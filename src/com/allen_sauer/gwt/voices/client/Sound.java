...
public interface Sound extends FiresSoundEvents {
  ...
  enum LoadState {
    ...
    /**
     * The sound load state is unknown, and cannot be determined. Hope for the
     * best. Calling {@link Sound#play()} may or may not work.
     */
    LOAD_STATE_SUPPORT_NOT_KNOWN,

    /**
     * Play back of this sound's MIME type is supported and this sound object is
     * ready for immediate play back. This means that the sound file has either
     * been downloaded by the client (when not streaming), or is ready for
     * streaming.
     */
    LOAD_STATE_SUPPORTED_AND_READY,

    /**
     * Play back of this sound's MIME type is known to be supported, however the
     * client browser is unable to provide load notification events. It cannot
     * be programmatically determined when the client has downloaded the sound.
     * When possible, an attempt will be made to begin downloading the sound
     * file in the background. The load state will NOT change to
     * {@link LoadState#LOAD_STATE_SUPPORTED_AND_READY}, or indeed to any other
     * state.
     */
    ...
    /**
     * Play back of this sound's MIME type is known to be supported, however the
     * sound file has not yet been loaded. The load state is at some point
     * expected to change to {@link LoadState#LOAD_STATE_SUPPORTED_AND_READY}.
     */
  ...
  /**
   * @deprecated Use {@link LoadState#LOAD_STATE_SUPPORTED_AND_READY} enum value
   *             instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link LoadState#LOAD_STATE_SUPPORTED_MAYBE_READY} enum
   *             value instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link LoadState#LOAD_STATE_SUPPORTED_NOT_READY} enum value
   *             instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link LoadState#LOAD_STATE_UNINITIALIZED} enum value
   *             instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link LoadState#LOAD_STATE_SUPPORT_NOT_KNOWN} enum value
   *             instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link LoadState#LOAD_STATE_NOT_SUPPORTED} enum value
   *             instead.
   */
  @Deprecated
   ...
   * Typical filename extensions include <code>.au</code> and <code>.snd</code>.
   */
   ...
   * unregistered, <code>audio/midi</code>. Typical filename extensions include
   * <code>.mid</code> and <code>.midi</code>.
   */
  ...
  /**
   * Get a brief, human readable, description of the sound type, which is an
   * indication of the mechanism used for play back. The returned value is
   * subject to change and is not intended to be machine parseable.
   * 
