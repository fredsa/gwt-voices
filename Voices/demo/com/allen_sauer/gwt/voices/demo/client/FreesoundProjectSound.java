...
public class FreesoundProjectSound extends ThirdPartySound {
  ...
  public ThirdPartySound copyOf() {
    return new FreesoundProjectSound(getMimeType(), actualURL, originalFreesoundProjectFilename,
        freesoundProjectFileURL, freesoundProjectSoundAuthor, freesoundProjectAuthorURL,
        audioFormatDescription);
  }
}
