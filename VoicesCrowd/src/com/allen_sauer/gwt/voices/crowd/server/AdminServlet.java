...
public class AdminServlet extends HttpServlet {
  ...
  private static void incrementTestResultCount(
      PersistenceManager pm, String userAgentString, String gwtUserAgent, String resultsString)
      throws IOException {
  ...
  private void loadTestData(PersistenceManager pm) throws IOException {
    incrementTestResultCount(pm,
    ...
    incrementTestResultCount(pm,"Opera/9.80 (X11; Linux x86_64; U; de) Presto/2.6.30 Version/10.60",
        "opera",
    ...
    incrementTestResultCount(pm,"Opera/9.80 (Windows NT 5.1; U; nl) Presto/2.6.30 Version/10.60",
    ...
    incrementTestResultCount(pm,"Opera/9.80 (Windows NT 6.0; U; en) Presto/2.6.30 Version/10.60",
        "opera", "||||||maybe|maybe|||||probably|probably|||||maybe|||probably");
    incrementTestResultCount(pm,
